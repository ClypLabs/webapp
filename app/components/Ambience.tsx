...
export default function Ambience() {
  return (
    ...
    >
      ...
      <div className="animate-drift-a absolute -left-[10%] top-[-15%] h-[720px] w-[900px] rounded-full bg-emerald-500/[0.10] blur-[160px]" />
      {/* Counterweight on the right, cooler, so the page is not lit evenly. */}
      <div className="animate-drift-b absolute -right-[15%] top-[25%] h-[640px] w-[820px] rounded-full bg-teal-400/[0.07] blur-[170px]" />
      {/* Low and centred, to keep the lower half of the page from going flat. */}
      <div className="animate-drift-c absolute bottom-[-10%] left-[20%] h-[600px] w-[860px] rounded-full bg-cyan-500/[0.06] blur-[170px]" />
      {/* Faint fourth on its own timing, so no pair of blobs ever lines up. */}
      <div className="animate-drift-b absolute left-[35%] top-[55%] h-[520px] w-[620px] rounded-full bg-emerald-400/[0.05] blur-[150px] [animation-duration:41s]" />
